...
RSpec.describe 'タスクモデル機能', type: :model do
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '', content: '失敗テスト', expired_at: "2022-01-01", status: "未着手", priority: "高")
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '失敗テスト', content: '', expired_at: "2022-01-01", status: "未着手", priority: "高")
  #       expect(task).not_to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '失敗テスト', content: '失敗テスト', expired_at: "", status: "未着手", priority: "高")
  #       expect(task).not_to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '失敗テスト', content: '失敗テスト', expired_at: "2022-01-01", status: "", priority: "高")
  #       expect(task).not_to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '失敗テスト', content: '失敗テスト', expired_at: "2022-01-01", status: "未着手", priority: "")
  #       expect(task).not_to be_valid
  #     end
  #   end
    ...
    #   it 'バリデーションが通る' do
    #     task = Task.new(title: "成功テスト", content: "成功テスト", expired_at: "2022-01-01", status: "未着手", priority: "高", user: 1)
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '*'*101, content: '失敗テスト', expired_at: "2022-01-01", status: "未着手", priority: "高")
  #       expect(task).not_to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションが通る' do
  #       task = Task.new(title: '*'*100, content: '成功テスト', expired_at: "2022-01-01", status: "未着手", priority: "高")
  #       expect(task).to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションに引っかかる' do
  #       task = Task.new(title: '失敗テスト', content: '*'*301, expired_at: "2022-01-01", status: "未着手", priority: "高")
  #       expect(task).not_to be_valid
  #     end
  #   end
  ...
  #     it 'バリデーションが通る' do
  #       task = Task.new(title: '成功テスト', content: '*'*300, expired_at: "2022-01-01", status: "未着手", priority: "高")
  #       expect(task).to be_valid
  #     end
  #   end
  # end
